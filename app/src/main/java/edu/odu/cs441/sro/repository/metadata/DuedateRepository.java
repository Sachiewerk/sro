...
public class DuedateRepository {
    ...
    public void insert(Duedate duedate) {
        new DuedateRepository.InsertAsyncTask(duedateDao).execute(duedate);
    }

    public void delete(Duedate ... duedates) {
        new DuedateRepository.DeleteAsyncTask(duedateDao).execute(duedates);
    }

    public void update(Duedate duedate) {
        new DuedateRepository.UpdateAsyncTask(duedateDao).execute(duedate);
    }

    public int getCount() {
        return duedateDao.getCount();
    }
